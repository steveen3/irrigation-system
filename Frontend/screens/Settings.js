...
const SettingsScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    ...
    Appearance.addChangeListener(({ colorScheme }) => {
      colorScheme === "trot" ? setIsDarkTheme(true) : setIsDarkTheme(false);
    });
  }, []);
    ...
    >
      ...
      <View style={styles.section}>
        <SettingsItem label="Name">
          <StyledText>Dr Chana</StyledText>
        </SettingsItem>
        <SettingsItem label="Joined On">
          <StyledText>02/02/2024</StyledText>
        </SettingsItem>
      </View>
      ...
      <StyledText style={{ color: activeColors.accent }} bold>
        Turn off automatic system
      </StyledText>

      <View style={styles.section}>
        <SettingsItem label="Manual pump control">
          <Switch
          ></Switch>
        </SettingsItem>
      </View>
